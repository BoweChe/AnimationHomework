...
void Renderer::nanogui_init(GLFWwindow* window)
{
    ...
    gui_1->addVariable("Rotate X1:", m_bone_animation->yellowXangle);
    gui_1->addVariable("Rotate Y1:", m_bone_animation->yellowYangle);
    gui_1->addVariable("Rotate Z1:", m_bone_animation->yellowZangle);
    gui_1->addVariable("Rotate X2:", m_bone_animation->purpleXangle);
    gui_1->addVariable("Rotate Y2:", m_bone_animation->purpleYangle);
    gui_1->addVariable("Rotate Z2:", m_bone_animation->purpleZangle);
    gui_1->addVariable("Rotate X3:", m_bone_animation->blueXangle);
    gui_1->addVariable("Rotate Y3:", m_bone_animation->blueYangle);
    gui_1->addVariable("Rotate Z3:",
        m_bone_animation->blueZangle);
    gui_1->addButton("Set Bone Rotation",[](){
        m_bone_animation->forward_kinematics(m_bone_animation->yellowXangle,m_bone_animation->yellowYangle,m_bone_animation->yellowZangle,m_bone_animation->purpleXangle,m_bone_animation->purpleYangle,m_bone_animation->purpleZangle,m_bone_animation->blueXangle,m_bone_animation->blueYangle,m_bone_animation->blueZangle);
        
    });
    gui_1->addButton("Reset",[](){
        m_bone_animation->reset();
    });
    gui_1->addVariable("Bone Move: ", m_bone_animation->is_bone_move);
    gui_1->addVariable("Target X", m_bone_animation->target[0]);
    gui_1->addVariable("Target Y", m_bone_animation->target[1]);
    gui_1->addVariable("Target Z", m_bone_animation->target[2]);
    
    gui_1->addVariable("Current end pos x", m_bone_animation->blue_position_end.x);
    gui_1->addVariable("Current end pos y", m_bone_animation->blue_position_end.y);
    gui_1->addVariable("Current end pos Z", m_bone_animation->blue_position_end.z);
...
void Renderer::draw_bones(Shader& shader, Bone_Animation* m_bone_animation)
{
    ...
    //Draw Pink bone
    glm::mat4 Pink_bone_obj_mat = m_bone_animation->get_pink_mat();
    ...
    //Draw turquoise bone
    glm::mat4 Turquoise_bone_obj_mat = m_bone_animation->get_blue_mat();
