...
void Renderer::nanogui_init(GLFWwindow* window)
{
    ...
    gui_1->addVariable("Rotate X1:", X1);
    gui_1->addVariable("Rotate Y1:", Y1);
    gui_1->addVariable("Rotate Z1:", Z1);
    gui_1->addVariable("Rotate X2:", X2);
    gui_1->addVariable("Rotate Y2:", Y2);
    gui_1->addVariable("Rotate Z2:", Z2);
    gui_1->addVariable("Rotate X3:", X3);
    gui_1->addVariable("Rotate Y3:", Y3);
    gui_1->addVariable("Rotate Z3:", Z3);
    gui_1->addButton("Reset Bone Rotation",[](){
        m_bone_animation->rotation_degree_vector[1][0]=X1;
        m_bone_animation->rotation_degree_vector[1][1]=Y1;
        m_bone_animation->rotation_degree_vector[1][2]=Z1;
        m_bone_animation->rotation_degree_vector[2][0]=X2;
        m_bone_animation->rotation_degree_vector[2][1]=Y2;
        m_bone_animation->rotation_degree_vector[2][2]=Z2;
        m_bone_animation->rotation_degree_vector[3][0]=X3;
        m_bone_animation->rotation_degree_vector[3][1]=Y3;
        m_bone_animation->rotation_degree_vector[3][2]=Z3;
...
void Renderer::draw_bones(Shader& shader, Bone_Animation* m_bone_animation)
{
    ...
    Yellow_bone_obj_mat = m_bone_animation->get_model_mat(Yellow_bone_obj_mat,1);
