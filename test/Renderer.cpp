...
//glm::mat4 Turquoise_bone_obj_mat = glm::mat4(1.0f);
void Renderer::nanogui_init(GLFWwindow* window)
{
    X1 = m_bone_animation->rotation_degree_vector[1][0];
    Y1 = m_bone_animation->rotation_degree_vector[1][1];
    Z1 = m_bone_animation->rotation_degree_vector[1][2];
    X2 = m_bone_animation->rotation_degree_vector[2][0];
    Y2 = m_bone_animation->rotation_degree_vector[2][1];
    Z2 = m_bone_animation->rotation_degree_vector[2][2];
    X3 = m_bone_animation->rotation_degree_vector[3][0];
    Y3 = m_bone_animation->rotation_degree_vector[3][1];
    Z3 = m_bone_animation->rotation_degree_vector[3][2];
    ...
    gui_1->addVariable("Rotate X1:", m_bone_animation->rotation_degree_vector[0][0]);
    gui_1->addVariable("Rotate Y1:", m_bone_animation->rotation_degree_vector[0][1]);
    gui_1->addVariable("Rotate Z1:", m_bone_animation->rotation_degree_vector[0][2]);
    gui_1->addVariable("Rotate X2:", m_bone_animation->rotation_degree_vector[1][0]);
    gui_1->addVariable("Rotate Y2:", m_bone_animation->rotation_degree_vector[1][1]);
    gui_1->addVariable("Rotate Z2:", m_bone_animation->rotation_degree_vector[1][2]);
    gui_1->addVariable("Rotate X3:", m_bone_animation->rotation_degree_vector[2][0]);
    gui_1->addVariable("Rotate Y3:", m_bone_animation->rotation_degree_vector[2][1]);
    gui_1->addVariable("Rotate Z3:",
        m_bone_animation->rotation_degree_vector[2][2]);
    gui_1->addButton("Set Bone Rotation",[](){
    });
    gui_1->addButton("Reset",[](){
        m_bone_animation->reset();
    });
    gui_1->addVariable("Bone Move", bval);
    gui_1->addVariable("Target X", m_bone_animation->object_position[0]);
    gui_1->addVariable("Target Y", m_bone_animation->object_position[1]);
    gui_1->addVariable("Target Z", m_bone_animation->object_position[2]);
    
    gui_1->addVariable("Current end pos x", m_bone_animation->object_position[0]);
    gui_1->addVariable("Current end pos y", cnpy);
    gui_1->addVariable("Current end pos Z", cnpz);
...
void Renderer::draw_bones(Shader& shader, Bone_Animation* m_bone_animation)
{
    ...
    //Draw Yellow bone
    //glm::mat4 Yellow_bone_obj_mat = m_bone_animation->Yellow_Bone();
    /*
    glm::mat4 Yellow_bone_obj_mat = glm::mat4(1.0f);
    Yellow_bone_obj_mat = glm::translate(Yellow_bone_obj_mat,glm::vec3(2.0f,1.5f,2.0f));
    Yellow_bone_obj_mat = m_bone_animation->get_model_mat(Yellow_bone_obj_mat,0);
    Yellow_bone_obj_mat = glm::translate(Yellow_bone_obj_mat,glm::vec3(0.0f,2.0f,0.0f));
    Yellow_bone_obj_mat = glm::scale(Yellow_bone_obj_mat,m_bone_animation->scale_vector[1]);
     */
    glm::mat4 Yellow_bone_obj_mat = m_bone_animation->Yellow_Bone();
    ...
    //Draw pink bone
    /*
    glm::mat4 Pink_bone_obj_mat = glm::mat4(1.0f);
    Pink_bone_obj_mat = glm::translate(Pink_bone_obj_mat,glm::vec3(0.0f,2.0f,0.0f));
    Pink_bone_obj_mat = m_bone_animation->get_model_mat(Pink_bone_obj_mat,1);
    Pink_bone_obj_mat = m_bone_animation->combine_matrix1(Yellow_bone_obj_mat,Pink_bone_obj_mat);
    ...
    Pink_bone_obj_mat = glm::scale(Pink_bone_obj_mat,m_bone_animation->scale_vector[2]);
     */
    glm::mat4 Pink_bone_obj_mat = m_bone_animation->Pink_Bone(Yellow_bone_obj_mat);
    glUniformMatrix4fv(glGetUniformLocation(shader.program, "model"), 1, GL_FALSE, glm::value_ptr(Pink_bone_obj_mat));
    bone_obj->obj_color = m_bone_animation->colors[2];
    draw_object(shader, *bone_obj);
    
    //Draw turquoise bone
    glm::mat4 Turquoise_bone_obj_mat = m_bone_animation->Turquoise_Bone(Pink_bone_obj_mat);
    /*
    glm::mat4 Turquoise_bone_obj_mat = glm::mat4(1.0f);
    Turquoise_bone_obj_mat = glm::translate(Turquoise_bone_obj_mat,glm::vec3(0.0f,1.5f,0.0f));
    Turquoise_bone_obj_mat = m_bone_animation->get_model_mat(Turquoise_bone_obj_mat,3);
    Turquoise_bone_obj_mat = m_bone_animation->combine_matrix2(Pink_bone_obj_mat,Turquoise_bone_obj_mat);
    Turquoise_bone_obj_mat = glm::translate(Turquoise_bone_obj_mat,glm::vec3(0.0f,1.0f,0.0f));
    Turquoise_bone_obj_mat = glm::scale(Turquoise_bone_obj_mat,m_bone_animation->scale_vector[3]);
     */
    glUniformMatrix4fv(glGetUniformLocation(shader.program, "model"), 1, GL_FALSE, glm::value_ptr(Turquoise_bone_obj_mat));
    bone_obj->obj_color = m_bone_animation->colors[3];
    draw_object(shader, *bone_obj);
    
    //Draw object
    glm::mat4 object_cube_mat = glm::mat4(1.0f);
    object_cube_mat = glm::translate(object_cube_mat,m_bone_animation->object_position);
    object_cube_mat = glm::scale(object_cube_mat,{1.0f,1.0f,1.0f});
    glUniformMatrix4fv(glGetUniformLocation(shader.program, "model"), 1, GL_FALSE, glm::value_ptr(object_cube_mat));
    bone_obj->obj_color = {0.0f,1.0f,0.0f,1.0f};
    draw_object(shader, *bone_obj);
